        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <flux:subheading>
                        {{ __('Kelola peran pengguna dan izin mereka di seluruh sistem.') }}
                    </flux:subheading>
                </div>
            ...
            <div class="mb-6 flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-950/30">
                ...
                <div class="flex-1 text-sm text-blue-800 dark:text-blue-300">
                    {{ __('Peran sistem (Super Admin, Admin) tidak dapat dihapus. Buat peran khusus yang sesuai dengan kebutuhan organisasi Anda.') }}
                </div>
            </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid gap-2 text-sm text-zinc-600 dark:text-zinc-400 sm:grid-cols-2">
                            <div class="flex items-start gap-2">
                                ...
                                <span>{{ __('Tetapkan peran kepada pengguna untuk mengontrol akses mereka ke fitur-fitur tertentu') }}</span>
                            </div>
                            <div class="flex items-start gap-2">
                                <svg class="mt-0.5 size-4 shrink-0 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                                <span>{{ __('Peran Super Admin memiliki akses ke semua fitur dan tidak dapat dimodifikasi.') }}</span>
                            </div>
                            <div class="flex items-start gap-2">
                                <svg class="mt-0.5 size-4 shrink-0 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                                <span>{{ __('Buat peran khusus untuk departemen atau fungsi pekerjaan tertentu') }}</span>
                            </div>
                            <div class="flex items-start gap-2">
                                <svg class="mt-0.5 size-4 shrink-0 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                </svg>
                                <span>{{ __('Tinjau izin secara berkala untuk memastikan keamanan.') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
